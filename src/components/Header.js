...
function Intro() {
  return (
            <Flex mb='2rem' bg='' justifyContent='center' direction={{base:'column', md:'row', lg:'row'}} space='7' shadow='lg'>
                ...
                <Center>
                  ...
                  <Flex justifyContent='center' direction='column'>
                    <Center>
                      ...
                      <Container maxWidth='100ch' mx='' fontSize='md' fontWeight='semibold'> I'm a former flight attendant with a love for tech, travel, and intellectual growth. 
                        ...
                        I loved my time in the sky, but now I'm ready to work in a different kind of cloud! My skills in web development are primarily self taught, but I do have past experience
                        in IT, a few active IT certifications (CCNA, A+, N+), and deep curiosity. 
                        You can count on me
